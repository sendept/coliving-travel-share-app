...
export const ChatInput = ({
  ...
  const getHelpText = () => {
    if (selectedLanguage === "es") {
      ...
      return "Write your route here: (e.g. I am Fabrizio and I'm traveling from Lisbon to Santiago. Date: 1.9 around 11:00 am. I have 2 seats available. My contact: 987654321)";
    }
  };
