...
export const ChatInput = ({
  ...
  return <form onSubmit={handleSubmit} className="relative mt-5">
      ...
      <div className="absolute bottom-2 right-2">
        <Button type="submit" size="icon" className="bg-gray-400 hover:bg-gray-500 text-white rounded-full p-2 w-8 h-8 flex items-center justify-center">
          <img src="/lovable-uploads/e1013e67-093e-4e89-8c93-cc1efa1ad085.png" alt="Send" className="w-6 h-6" />
        </Button>
      </div>
